...
--*/
{
    ...
    do
    {
        ...
        KdPrint(("==> Miniport Initialize: Adapt %p\n", pAdapt));
...
--*/
{
    ...
    do
    {
        ...
        if (Status != NDIS_STATUS_PENDING)
        {
            GingkoNdisRequestComplete(pAdapt, &pAdapt->Request, Status);
            Status = NDIS_STATUS_PENDING;
        }
...
VOID
GingkoNdisQueryPNPCapabilities(
...
--*/
{
    ...
    do
    {
        ...
        {
            GingkoNdisProcessSetPowerOid(&Status, 
                                 pAdapt, 
                                 InformationBuffer, 
...
--*/
{
    ...
    // was created.
    //
    (VOID)GingkoNdisDeregisterDevice();
