...
typedef struct _GkoShellExt_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } GkoShellExt_MIDL_TYPE_FORMAT_STRING;

typedef struct _GkoShellExt_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } GkoShellExt_MIDL_PROC_FORMAT_STRING;

typedef struct _GkoShellExt_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } GkoShellExt_MIDL_EXPR_FORMAT_STRING;
...
extern const GkoShellExt_MIDL_TYPE_FORMAT_STRING GkoShellExt__MIDL_TypeFormatString;
extern const GkoShellExt_MIDL_PROC_FORMAT_STRING GkoShellExt__MIDL_ProcFormatString;
extern const GkoShellExt_MIDL_EXPR_FORMAT_STRING GkoShellExt__MIDL_ExprFormatString;
...
extern const MIDL_SERVER_INFO IGingkoContextMenuExt_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO IGingkoContextMenuExt_ProxyInfo;
...
static const GkoShellExt_MIDL_PROC_FORMAT_STRING GkoShellExt__MIDL_ProcFormatString =
    {
        0,
        {
...
static const GkoShellExt_MIDL_TYPE_FORMAT_STRING GkoShellExt__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
static const MIDL_STUBLESS_PROXY_INFO IComponentRegistrar_ProxyInfo =
    {
    &Object_StubDesc,
    GkoShellExt__MIDL_ProcFormatString.Format,
...
/* Object interface: IGingkoContextMenuExt, ver. 0.0,
   GUID={0xDE85BF1D,0x8185,0x4C31,{0x94,0xFC,0xC1,0x9E,0xE6,0xE4,0xC7,0xF9}} */

#pragma code_seg(".orpc")
static const unsigned short IGingkoContextMenuExt_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO IGingkoContextMenuExt_ProxyInfo =
    {
    &Object_StubDesc,
    GkoShellExt__MIDL_ProcFormatString.Format,
    &IGingkoContextMenuExt_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO IGingkoContextMenuExt_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    GkoShellExt__MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(7) _IGingkoContextMenuExtProxyVtbl = 
{
    0,
    &IID_IGingkoContextMenuExt,
    IUnknown_QueryInterface_Proxy,
    IUnknown_AddRef_Proxy,
    IUnknown_Release_Proxy ,
    0 /* IDispatch::GetTypeInfoCount */ ,
...
static const PRPC_STUB_FUNCTION IGingkoContextMenuExt_table[] =
{
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
...
CInterfaceStubVtbl _IGingkoContextMenuExtStubVtbl =
{
    &IID_IGingkoContextMenuExt,
    &IGingkoContextMenuExt_ServerInfo,
    7,
    &IGingkoContextMenuExt_table[-3],
    CStdStubBuffer_DELEGATING_METHODS
};
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    GkoShellExt__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _GkoShellExt_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IGingkoContextMenuExtProxyVtbl,
    ( CInterfaceProxyVtbl *) &_IComponentRegistrarProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _GkoShellExt_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IGingkoContextMenuExtStubVtbl,
    ( CInterfaceStubVtbl *) &_IComponentRegistrarStubVtbl,
    0
...
PCInterfaceName const _GkoShellExt_InterfaceNamesList[] = 
{
    "IGingkoContextMenuExt",
    "IComponentRegistrar",
    0
};

const IID *  const _GkoShellExt_BaseIIDList[] = 
{
    &IID_IDispatch,
    &IID_IDispatch,
    0
...
#define _GkoShellExt_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _GkoShellExt, pIID, n)

int __stdcall _GkoShellExt_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _GkoShellExt, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _GkoShellExt, 2, *pIndex )
    
}

const ExtendedProxyFileInfo GkoShellExt_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _GkoShellExt_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _GkoShellExt_StubVtblList,
    (const PCInterfaceName * ) & _GkoShellExt_InterfaceNamesList,
    (const IID ** ) & _GkoShellExt_BaseIIDList,
    & _GkoShellExt_IID_Lookup, 
    2,
    2,
