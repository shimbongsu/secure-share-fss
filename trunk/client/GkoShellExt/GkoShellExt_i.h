...
#ifndef __GkoShellExt_i_h__
#define __GkoShellExt_i_h__
...
#ifndef __IGingkoContextMenuExt_FWD_DEFINED__
#define __IGingkoContextMenuExt_FWD_DEFINED__
typedef interface IGingkoContextMenuExt IGingkoContextMenuExt;
#endif 	/* __IGingkoContextMenuExt_FWD_DEFINED__ */
...
#ifndef __CGingkoContextMenuExt_FWD_DEFINED__
#define __CGingkoContextMenuExt_FWD_DEFINED__

#ifdef __cplusplus
typedef class CGingkoContextMenuExt CGingkoContextMenuExt;
#else
typedef struct CGingkoContextMenuExt CGingkoContextMenuExt;
#endif /* __cplusplus */

#endif 	/* __CGingkoContextMenuExt_FWD_DEFINED__ */
...
#ifndef __IGingkoContextMenuExt_INTERFACE_DEFINED__
#define __IGingkoContextMenuExt_INTERFACE_DEFINED__

/* interface IGingkoContextMenuExt */
/* [unique][helpstring][nonextensible][dual][uuid][object] */ 


EXTERN_C const IID IID_IGingkoContextMenuExt;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("DE85BF1D-8185-4C31-94FC-C19EE6E4C7F9")
    IGingkoContextMenuExt : public IDispatch
    {
    public:
    };
    ...
    typedef struct IGingkoContextMenuExtVtbl
    {
        BEGIN_INTERFACE
        
        HRESULT ( STDMETHODCALLTYPE *QueryInterface )( 
            IGingkoContextMenuExt * This,
            /* [in] */ REFIID riid,
            /* [annotation][iid_is][out] */ 
            __RPC__deref_out  void **ppvObject);
        ...
        END_INTERFACE
    } IGingkoContextMenuExtVtbl;

    interface IGingkoContextMenuExt
    {
        CONST_VTBL struct IGingkoContextMenuExtVtbl *lpVtbl;
    };
...
#define IGingkoContextMenuExt_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define IGingkoContextMenuExt_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define IGingkoContextMenuExt_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 


#define IGingkoContextMenuExt_GetTypeInfoCount(This,pctinfo)	\
    ( (This)->lpVtbl -> GetTypeInfoCount(This,pctinfo) ) 

#define IGingkoContextMenuExt_GetTypeInfo(This,iTInfo,lcid,ppTInfo)	\
    ( (This)->lpVtbl -> GetTypeInfo(This,iTInfo,lcid,ppTInfo) ) 

#define IGingkoContextMenuExt_GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId)	\
    ( (This)->lpVtbl -> GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId) ) 

#define IGingkoContextMenuExt_Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr)	\
    ( (This)->lpVtbl -> Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr) ) 
...
#endif 	/* __IGingkoContextMenuExt_INTERFACE_DEFINED__ */



#ifndef __GkoShellExtLib_LIBRARY_DEFINED__
#define __GkoShellExtLib_LIBRARY_DEFINED__

/* library GkoShellExtLib */
/* [custom][helpstring][version][uuid] */ 


EXTERN_C const IID LIBID_GkoShellExtLib;

EXTERN_C const CLSID CLSID_CompReg;

#ifdef __cplusplus

class DECLSPEC_UUID("D1046D0B-8B45-461D-A3C8-253F93958D3F")
CompReg;
#endif

EXTERN_C const CLSID CLSID_CGingkoContextMenuExt;

#ifdef __cplusplus

class DECLSPEC_UUID("7DFB6A6B-8CB7-4B1B-9CA9-6C9F11E923C9")
CGingkoContextMenuExt;
#endif
#endif /* __GkoShellExtLib_LIBRARY_DEFINED__ */
