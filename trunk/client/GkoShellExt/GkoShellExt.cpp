// GkoShellExt.cpp : Implementation of DLL Exports.
...
{
	//Installed the Approved Context Menu
	//HKCM\SOFTWARE\Microsoft\Windows\CurrentVersion\Shell Extensions\Approved
