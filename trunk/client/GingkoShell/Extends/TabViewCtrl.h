 ...
 */
//==============================================================================
class CFreakTabViewCtrl : public WTL::aero::CTabCtrl,
	public CMessageFilter, public CIdleHandler
{
	...
	public:
		...
		CFreakTabViewCtrl( HWND hWnd ) :	
			TABVIEW_BORDER		( 3 ),
			TABVIEW_EDGE		( 5 ),
			m_ActiveTabIndex	( -1 ) 
		{ 
			aero::CTabCtrl::m_hWnd = hWnd;
		}
		...
		virtual BOOL PreTranslateMessage(MSG* pMsg)
		{
			...
			{
				if( m_Views[ theIndex ].IsDialogMessage( pMsg ) )
					return TRUE;
			}
	...
	protected:
		...
		LRESULT OnResize(UINT, WPARAM, LPARAM, BOOL& bHandled )
		{
			UpdateViews();
			bHandled = FALSE;
			return 0;
