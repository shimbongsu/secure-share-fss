...
/* Internet Explorer limit. Includes the terminating null character. */
...
typedef enum
{
	...
	TERR_OS_ERROR							= 1,
	TERR_OUTOFMEMORY							= 2,
	TERR_PASSWORD_WRONG						= 3,
	TERR_VOL_FORMAT_BAD						= 4,
	TERR_DRIVE_NOT_FOUND						= 5,
	TERR_FILES_OPEN							= 6,
	TERR_VOL_SIZE_WRONG						= 7,
	TERR_COMPRESSION_NOT_SUPPORTED			= 8,
	TERR_PASSWORD_CHANGE_VOL_TYPE			= 9,
	TERR_PASSWORD_CHANGE_VOL_VERSION			= 10,
	TERR_VOL_SEEKING							= 11,
	TERR_VOL_WRITING							= 12,
	TERR_FILES_OPEN_LOCK						= 13,
	TERR_VOL_READING							= 14,
	TERR_DRIVER_VERSION						= 15,
	TERR_NEW_VERSION_REQUIRED				= 16,
	TERR_CIPHER_INIT_FAILURE					= 17,
	TERR_CIPHER_INIT_WEAK_KEY				= 18,
	TERR_SELF_TESTS_FAILED					= 19,
	TERR_SECTOR_SIZE_INCOMPATIBLE			= 20,
	TERR_VOL_ALREADY_MOUNTED					= 21,
	TERR_NO_FREE_DRIVES						= 22,
	TERR_FILE_OPEN_FAILED					= 23,
	TERR_VOL_MOUNT_FAILED					= 24,
	TDEPRECATED_ERR_INVALID_DEVICE			= 25,
	TERR_ACCESS_DENIED						= 26,
	TERR_MODE_INIT_FAILED					= 27,
	TERR_DONT_REPORT							= 28,
	TERR_ENCRYPTION_NOT_COMPLETED			= 29,
	TERR_PARAMETER_INCORRECT					= 30,
	TERR_SYS_HIDVOL_HEAD_REENC_MODE_WRONG	= 31,
	TERR_NONSYS_INPLACE_ENC_INCOMPLETE		= 32,
	TERR_USER_ABORT							= 33
} ERROR_CODE_LIST;
